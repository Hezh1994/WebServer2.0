...
/**
 * 根据Http请求中的路径查找文件的工具类。如果是文件，则返回File对象;如果是集合，则返回一个File对象的List集合
 * 
 * @author succez
 *
 */
public class Seeker {
	...
	/**
	 * 根据url查找并返回指定文件。如:url =
	 * "/d/document/test.txt",则能返回路径为D:\document\test.txt的文件。
	 * 
	 * @param url
	 * @return
	...
	/**
	 * 遍历当前目录，返回一个File对象的List集合，集合中的每个元素对应当前目录下得到每个文件和目录。
	 * 
	 * @param file
	 *            目录
	 * @return
